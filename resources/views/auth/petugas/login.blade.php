...
<head>
    ...
    <title>Login Petugas - SPK Stunting</title>
...
<body>
    ...
    <div class="auth-wrapper">
        ...
        <!-- Panel kiri: identitas & keterangan -->
        <div class="auth-brand">
            ...
            <div class="auth-brand-body">
                ...
                <h2>Catat data balita langsung dari lapangan.</h2>
                <p>Panel petugas digunakan untuk mendaftarkan data balita dan memantau hasil penilaian status gizi di wilayah kerja Puskesmas Losari.</p>
            </div>

            <div class="auth-brand-note">
                <i class="bi bi-person-badge-fill"></i>
                <span>Halaman ini untuk petugas Puskesmas. Belum punya akun? Daftar terlebih dahulu di bawah.</span>
            </div>
        </div>
        ...
        <div class="auth-form-panel">
            <div class="auth-form-inner">
                ...
                <p class="subtitle">Masuk untuk melanjutkan ke dashboard petugas.</p>
                ...
                <form method="POST" action="{{ route('petugas.login.post') }}">
                    ...
                    <p class="switch-link">
                        Belum punya akun? <a href="{{ route('petugas.register') }}">Daftar di sini</a>
                    </p>
                </form>
            </div>
        </div>
