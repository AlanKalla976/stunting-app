...
<head>
    ...
    <title>Login Admin - SPK Stunting</title>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-brand">
            ...
            <div class="auth-brand-body">
                ...
                <h2>Kelola data penilaian gizi balita dengan tenang.</h2>
                <p>Panel admin digunakan untuk mengatur kriteria penilaian, data pengguna, dan hasil perankingan status gizi balita di Puskesmas Losari.</p>
            </div>

            <div class="auth-brand-note">
                <i class="bi bi-shield-lock-fill"></i>
                <span>Halaman ini khusus untuk administrator sistem. Petugas lapangan silakan login melalui halaman Login Petugas.</span>
            </div>
        </div>
        ...
        <div class="auth-form-panel">
            <div class="auth-form-inner">
                ...
                <p class="subtitle">Masuk untuk melanjutkan ke dashboard administrasi.</p>
