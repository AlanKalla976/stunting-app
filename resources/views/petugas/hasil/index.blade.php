...
@section('page_title', 'Hasil Ranking (Petugas)')

@section('content')
<style>
    table.table-hasil-petugas > thead > tr > th {
        background-color: #3b5bfd !important;
        color: #ffffff !important;
        border: none !important;
        vertical-align: middle;
    }
    table.table-hasil-petugas > thead > tr > th:first-child {
        border-top-left-radius: 12px !important;
        border-bottom-left-radius: 12px !important;
    }
    table.table-hasil-petugas > thead > tr > th:last-child {
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
    ...
    @if($hasil->isNotEmpty())
        <a href="{{ route('petugas.hasil.cetak') }}" class="btn text-white rounded-3 px-4 py-2 fw-semibold" style="background-color:#e5484d;">
...
<div class="card border-0 shadow-sm rounded-4 p-4">
    ...
    <div class="table-responsive">
        <table class="table table-hasil-petugas align-middle mb-0" style="border-collapse: separate; border-spacing: 0;">
            <thead>
                <tr>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted p-4">
                            ...
                            Belum ada hasil perhitungan. Silakan hubungi Admin.
                        </td>
                    </tr>
                @endforelse
            </tbody>
