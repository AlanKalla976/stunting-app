...
@section('page_title', 'Detail Data Balita (Petugas)')
    ...
    <div class="col-md-8">
        <div class="card card-custom border-0 bg-white p-4">
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('petugas.balita.index') }}" class="btn btn-outline-secondary px-4 rounded-pill">Kembali</a>
                <a href="{{ route('petugas.balita.edit', $balita->id_balita) }}" class="btn text-white px-4 rounded-pill" style="background-color:#f5a623;">Edit Data</a>
            </div>
        </div>
    </div>
</div>
